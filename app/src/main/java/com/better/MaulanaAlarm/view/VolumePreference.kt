...
package com.better.MaulanaAlarm.view
...
import com.better.MaulanaAlarm.background.PluginAlarmData
import com.better.MaulanaAlarm.background.TargetVolume
import com.better.MaulanaAlarm.configuration.Prefs
import com.better.MaulanaAlarm.configuration.Prefs.Companion.MAX_PREALARM_VOLUME
...
import com.better.MaulanaAlarm.util.subscribeIn
...
class VolumePreference(mContext: Context, attrs: AttributeSet) : Preference(mContext, attrs) {
  ...
  /** Called from [com.better.MaulanaAlarm.presenter.SettingsFragment.onResume] */
  fun onResume() {
  ...
  /** Called from [com.better.MaulanaAlarm.presenter.SettingsFragment.onPause] */
  fun onPause() {
    stopMasterSample()
    stopPrealarmSample()
  }
